  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Tasky, your ultimate companion for organizing life's work. Simplify, prioritize, and accomplish your tasks with ease and efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Tasky, your ultimate companion for organizing life's work. Simplify, prioritize, and accomplish your tasks with ease and efficiency.`}
            </Text>
            <Box
